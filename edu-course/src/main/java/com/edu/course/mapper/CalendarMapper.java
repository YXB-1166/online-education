...
public interface CalendarMapper {
    ...
    @Select("select a.id as eventId, a.title, a.deadline as startTime, null as endTime, " +
            ...
            "and c.status in ('2','3') " +
            "union all " +
            "select e.id as eventId, e.title COLLATE utf8mb4_unicode_ci, e.start_time as startTime, e.end_time as endTime, " +
            ...
            "and e.status = 1 " +
            "union all " +
            "select c.id as eventId, concat('结课考试: ', c.course_name) COLLATE utf8mb4_unicode_ci as title, " +
            "c.exam_time as startTime, null as endTime, " +
